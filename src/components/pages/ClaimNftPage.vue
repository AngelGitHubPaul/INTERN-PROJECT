  ...
  <body>    
    <section class="relative flex items-center justify-center w-screen h-screen">
      <div id="#main" class="relative flex flex-col items-center justify-center">
        ...
        <!-- <Teleport to="section"> -->
        <div v-if="mintedNftURI != null && mintedNftTokenId != null && mintedNftDetails != null" class="fixed top-0 left-0 w-[100vw] h-[100vh] flex items-center justify-center bg-black/60 z-10">
